...
let melodyRightHand: [SheetNote] = [
    ...
    .init(notes: [.init(.D, 1), .init(.D, 2)], length: .eigth, velocity: 0.8),
    .init(notes: [.init(.A, 1), .init(.A, 2)], length: .eigth, velocity: 1.0),
    //MARK: -1
    .init(notes: [.init(.Asharp, 1), .init(.Asharp, 2)], length: .fourth, velocity: 1.3),
    ...
    .init(notes: [.init(.A, 1)], length: .fourth),
    //MARK: -20
    .init(notes: [.init(.D, 2)], length: .fourth),
    .init(notes: [.init(.D, 1)], length: .fourth),
    ...
    .init(notes: [.init(.A, 2)], length: .eigth),
    .init(notes: [.init(.A, 1)], length: .eigth),
    .init(notes: [.init(.C, 1)], length: .eigth),
    .init(notes: [.init(.E, 2)], length: .eigth),
    //MARK: -25
    .init(notes: [.init(.A, 2)], length: .fourth),
    .init(notes: [.init(.A, 1)], length: .fourth),
    //MARK: -26
    ...
    .init(notes: [.init(.D, 1), .init(.D, 2)], length: .fourth),
    //MARK: -2
    .init(notes: [.init(.C, 1), .init(.C, 2)], length: .fourth),
    .init(notes: [.init(.E, 1), .init(.E, 2)], length: .fourth),
    //MARK: -3
    .init(notes: [.init(.F, 1), .init(.F, 2)], length: .fourth),
    .init(notes: [.init(.C, 1), .init(.C, 2)], length: .fourth),
    //MARK: -4
    ...
    //MARK: -5
    .init(notes: [.init(.Asharp, 1), .init(.Asharp, 2)], length: .fourth),
    .init(notes: [.init(.G, 0), .init(.G, 1)], length: .fourth),

]
    //MARK: -LEFT HAND
let melody: [SheetNote] = [
    .init(notes: [.init(.D, 4), .init(.F, 4), .init(.A, 5)], length: .eigth, velocity: 0.8),
    .init(notes: [.init(.E, 4), .init(.A, 5), .init(.C, 5)], length: .eigth, velocity: 1.0),
    //MARK: -1
    .init(notes: [.init(.F, 4), .init(.Asharp, 5), .init(.D, 5)], length: KeyLength.eigth, velocity: 1.4),
    ...
    //MARK: -line 1
    //MARK: -1
    .init(notes: [.init(.D, 3), .init(.F, 3), .init(.Asharp, 4), .init(.D, 4)], length: KeyLength.half, velocity: 2.0),
    //MARK: -2
    ...
    //MARK: -3
    .init(notes: [.init(.F, 3), .init(.A, 4), .init(.C, 4)], length: KeyLength.fourth, velocity: 1.4),
    ...
    //MARK: -6
    .init(notes: [.init(.D, 3), .init(.F, 3), .init(.A, 4)], length: KeyLength.fourth, velocity: 1.6),
    .init(notes: [.init(.D, 3), .init(.D, 4)], length: KeyLength.eigth.extended),
    .init(notes: [.init(.D, 3), .init(.D, 4)], length: KeyLength.sixteenth),
    //MARK: -7
    .init(notes: [.init(.D, 3), .init(.D, 4)], length: KeyLength.fourth, velocity: 1.6),
    .init(notes: [.init(.Asharp, 3), .init(.D, 3)], length: KeyLength.eigth.extended),
    .init(notes: [.init(.F, 3)], length: KeyLength.sixteenth),
    //MARK: -8
